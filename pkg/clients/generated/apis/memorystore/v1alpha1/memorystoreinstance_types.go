...
// +optional
PscConnection *InstancePscConnection `json:"pscConnection,omitempty"`
}
...
type InstancePscConnection struct {
...
/* Detailed information of a PSC connection that is created by the user. */
// +optional
PscConnection *InstancePscConnectionStatus `json:"pscConnection,omitempty"`
}
...
type InstancePscConnectionStatus struct {
/* Output only. Type of the PSC connection. */
// +optional
ConnectionType *string `json:"connectionType,omitempty"`
